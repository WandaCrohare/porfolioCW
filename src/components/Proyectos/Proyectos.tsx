    ...
    <section className="proyectos-hero-bg">
      <div className="proyectos-card">
        ...
        <ul className="proyectos-lista">
          <li>
            <strong>Diseño y desarrollo web a medida</strong>
          ...
          <li>
            <strong>UX/UI & prototipado</strong>
          ...
          <li>
            <strong>Consultoría en IA, diseño e innovación</strong>
          ...
          <li>
            <strong>Soluciones creativas para ideas únicas</strong>
