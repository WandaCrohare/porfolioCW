  ...
  return (
    ...
    <section className="hero-bg">
      ...
      <div className="hero-bg-overlay">
        ...
        <div className="hero-card">
          ...
          <div className="hero-card-content">
            <div className="hero-card-left">
              <span className="hero-nombre">Hola! Soy Wanda</span>
        ...
        <div>
          <img src="/src/assets/WANDY1.png" alt="Wanda Croharé" className="hero-me"/>
        </div>
          ...
          <ul>
            ...
            <li>
              <a href="https://www.instagram.com/bchiang7" aria-label="Instagram" target="_blank" rel="noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <title>Instagram</title><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect>
